...
class TestMainIntegration:
    """Integration tests for main CLI with real dependencies (where feasible)."""

    def test_main_with_real_config_loading(self):
    ...
    def test_main_telemetry_export_integration(self):
...
class TestMainErrorHandling:
    ...
    def test_main_handles_run_viz_exceptions(self, mock_load_config, mock_run_viz):
